...
public class Controller {
    ...
    void initialize() {
        startButton.setOnAction(event -> {
            Integer rStart = new Integer(rStart_p.getText());
            Integer rSize = new Integer(rSize_p.getText());
            Integer cStart = new Integer(cStart_p.getText());
            Integer cSize = new Integer(cSize_p.getText());
